...
import { inputColor, textDesColor, startBtn, whiteSmoke, whiteColor, bgChat, borderColor } from '../../config/colors';
    ...
    return (
        <BaseComponent {...baseComponentData} title={'Sign Up'}>
            ...
            <View style={{flex:1,backgroundColor: themeStyle[theme].backgroundColor}}>
                ...
                <View style={{flexDirection: 'row', justifyContent: 'space-between', width: deviceWidth, padding: main_padding, marginTop: main_padding * 2}}>
                    <TextInput 
                        style={{...styles.input, width: '47%',backgroundColor: themeStyle[theme].primary,borderColor:inputBorder}}
                ...
                <VStack px={main_padding} marginTop={2}>
                    <TextInput 
                        style={{...styles.input,backgroundColor: themeStyle[theme].primary,borderColor:inputBorder}}
                    ...
                    />
                    <TextInput 
                        style={{...styles.input,marginTop: 20,backgroundColor: themeStyle[theme].primary,borderColor:inputBorder}}
                ...
                <View style={{width: deviceWidth*.9,justifyContent: 'center',alignItems:'center',marginTop:30,alignSelf:'center'}}>
