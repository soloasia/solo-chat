			 ...
			 <Transitioning.View style={{ flex: 1 }} {...{ ref, transition }}>
				...
				<FlatListScroll style={{padding: main_padding,}}>
					...
					<FlatListVertical
						...
						renderItem={_renderItem}
					/>
					<TouchableOpacity onPress={handleLogout} style={{width:'100%',height:45,backgroundColor: themeStyle[theme].primary,marginTop:main_padding,borderRadius:10,justifyContent:'center'}}>
